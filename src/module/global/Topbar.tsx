...
const Topbar = () => {
	return (
		<div className="h-[60px] flex items-center justify-between px-10 bg-primary rounded-b-md">
			{/* logo section  */}
			<h1 className="text-3xl font-bold text-white font-InriaSerif">
				Artify
			</h1>

			{/* search section  */}
			<div className="h-[42px] bg-white w-full max-w-[500px] rounded-border10 flex items-center pl-4 py-[3px] pr-[3px] gap-2">
				...
				<div className="h-[46px] border border-white p-1 rounded-border10 flex items-center">
					...
					<div className="ml-4 text-right text-white">
						...
						<p className="text-xs opacity-80">
							meow.admin@gmail.com
						</p>
					</div>
					<div className="h-full ml-2 aspect-square">
						<img
							src="https://images.unsplash.com/photo-1546358321-2754954c3a43?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
							alt="avatar"
